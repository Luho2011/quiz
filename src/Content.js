    ...
    <div className='content'>
       <div className='game_buttons'>
        ...
        <Link to='/movies' target="_blank">
          <button className='game_button'><h2>Filmquiz 1</h2><img className='movie_logo' src={Movie} alt="" onClick={""}/></button>
        </Link>
        <Link to='/theme' target="_blank">
          <button className='game_button'><h2>Intros</h2><img className='rewind_logo' src={theme} alt="" onClick={""}/></button>
        </Link>
        <Link to='/movies2' target="_blank">
          <button className='game_button'><h2>Filmquiz 2</h2><img className='movie2_logo' src={Movie2} alt="" onClick={""}/></button>
        </Link>
        <Link to='/Claim' target="_blank">
          <button className='game_button'><h2>Wer lügt?</h2><img className='claim_logo' src={Claim} alt="" onClick={""}/></button>
        </Link>
        <Link to='/WhoKnowsMore' target="_blank">
          <button className='game_button'><h2>WhoKnowsMore</h2><img className='whoknowsmore' src={WhoKnowsMore} alt="" onClick={""}/></button>
        </Link>
        <Link to='/playlistSetupHitster' target="_blank">
          <button className='game_button'><h2>Hitster</h2><img className='musicTrivia' src={musicTrivia} alt="" onClick={""}/></button>
        </Link>
        <Link to='/association' target="_blank">
          <button className='game_button'><h2>Assoziation</h2><img className='musicTrivia' src={WordsAssociation} alt="" onClick={""}/></button>
        </Link>
       </div>
    </div>
  )
